...
description: 在 gin 中 一次完成 request 中的所有需要数据绑定， 不再做第二次
keywords: go, gin, binding request
tags:
- golang
- gin
title: ginbinder 一次绑定所有 request 参数
---
...
![gopher-binding](/assets/img/post/2021/08/19/ginbinder/gopher-binding.jpeg)
...
![params-request-relationship.png](/assets/img/post/2021/08/19/ginbinder/params-request-relationship.png)

> 图中有一个错误， `12/13 行` 的 `tag` 应该是 `query`。

按照 Request 结构设计参数很 **常用** 也很清晰。

![result-demo1](/assets/img/post/2021/08/19/ginbinder/result-demo1.png)
...
![result-demo2](/assets/img/post/2021/08/19/ginbinder/result-demo2.png)
...
![result-demo3](/assets/img/post/2021/08/19/ginbinder/result-demo3.png)
